import { registerUserWithEmailAndPassword, signInWithGoogle, loginWithEmailAndPassword, logoutFirebase } from "../../firebase/providers";
...
export const startCreatingUserWithUserAndPassowrd = ({ email, password, displayName }) => {
    return async (dispatch) => {
        dispatch(checkingCredentials());
